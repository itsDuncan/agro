...
SECRET_KEY = 'b-sp2g^vmjy7cpir7y+i9z-&rfj7lgxn2bw3gcf=v#gg^bq=z*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [Path.home().joinpath(BASE_DIR, 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATIC_ROOT = Path.home().joinpath(BASE_DIR, 'staticfiles/')
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = 'Smart Farmer: '
